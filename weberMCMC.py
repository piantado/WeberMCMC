...
if __name__ == "__main__":
	...
	parser.add_argument('--prior', dest='prior', type=str, default='Inverse', nargs="?", help='The prior (Uniform, Jeffreys, Gamma)')
	...
	for subject, ds in data.groupby('subject'):
		...
		elif args['prior'] == 'InverseGamma':   model = pymc.Model(make_model_InverseGamma(    n1, n2, ntrials, ncorrect))
